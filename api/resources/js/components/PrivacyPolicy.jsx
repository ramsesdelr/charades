    ...
    render() {
          return <div>
            <div className="mt-3 mb-3 text-center">
                <Link to="/home"><img src="/svg/charades-logo.svg" className="logo-top"></img></Link>
            </div>
            <h2><b>Privacy Policy</b></h2>
            <p>Effective date: 2020-11-10</p>
            <p>1. <b>Introduction</b></p>
            <p>Welcome to <b> Charades Online</b>.</p>
            <p><b>Charades Online</b> (“us”, “we”, or “our”) operates <b>https://charades.live</b> (hereinafter referred to as <b>“Service”</b>).</p>
            <p>Our Privacy Policy governs your visit to <b>https://charades.live</b>, and explains how we collect, safeguard and disclose information that results from your use of our Service.</p>
            ...
            <p><b>SERVICE</b> means the https://charades.live website operated by Charades Online.</p>
            ...
            <p>Charades Online uses the collected data for various purposes:</p>
            ...
            <p> If you wish to be informed what Personal Data we hold about you and if you want it to be removed from our systems, please email us at <b>ramsesdelr@gmail.com</b>.</p>
            ...
            <p>0.4. users are able to change their personal information by emailing us at <b>ramsesdelr@gmail.com</b>.</p>
            ...
            <p>To exercise your California data protection rights described above, please send your request(s) by email: <b>ramsesdelr@gmail.com</b>.</p>
            ...
            <p>If you have any questions about this Privacy Policy, please contact us by email: <b>ramsesdelr[@]gmail.com</b>.</p>
            <footer className="footer-container text-center"><img src="/svg/charades-logo.svg" className="logo-bottom"/></footer>
          </div>;
    }
}
